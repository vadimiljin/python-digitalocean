...
class Manager(BaseAPI):
    ...
    def get_all_droplets(self, params=None, tag_name=None):
        ...
        for jsoned in data['droplets']:
            ...
            droplet.backups = True if 'backups' in droplet.features else False
            droplet.ipv6 = True if 'ipv6' in droplet.features else False
    ...
    def get_all_volumes(self, region=None):
        ...
        """
        url = 'volumes?region={}'.format(region) if region else 'volumes'
